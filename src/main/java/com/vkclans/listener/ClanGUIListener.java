...
public class ClanGUIListener implements Listener {
    ...
    public void onInventoryClick(InventoryClickEvent event) {
        // DEBUG: verifica se o evento está sendo chamado
        VKClans.getInstance().getLogger().info("[DEBUG] InventoryClickEvent disparado!");
        ...
        // DEBUG: mostra título mesmo se for null
        VKClans.getInstance().getLogger().info("[DEBUG] Título bruto: '" + title + "'");
        ...
        // DEBUG: mostra o título no console
        VKClans.getInstance().getLogger().info("[DEBUG] Título limpo: '" + cleanTitle + "'");
        ...
        // DEBUG
        VKClans.getInstance().getLogger().info("[DEBUG] Main=" + isMainMenu + " Members=" + isMembersMenu + " Invites=" + isInvitesMenu + " Confirm=" + isConfirmMenu);
        
        // Se não for nenhum menu do clã, ignora
        if (!isMainMenu && !isMembersMenu && !isInvitesMenu && !isConfirmMenu) return;
        ...
        // DEBUG
        VKClans.getInstance().getLogger().info("[DEBUG] Item clicado: " + item.getType() + " - " + name);
